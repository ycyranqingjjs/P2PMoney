...
public abstract class LoadingPage extends FrameLayout {
    ...
    private static final int PAGE_LOADING_STATE = 1;//正在加载

    private static final int PAGE_ERROR_STATE = 2;//错误

    private static final int PAGE_EMPTY_STATE = 3;//空数据

    private static final int PAGE_SUCCESS_STATE = 4;//成功

    private int PAGE_CURRENT_STATE = 1;//初始状态
    ...
    private void showPage() {
        ...
        if (successView == null) {
            successView = View.inflate(mConext, LayoutId(), null);//这里一定要用mConext 不能再用UIutils了
